...
const SKILL_GROUPS: SkillGroup[] = [
  {
    category: 'Frontend',
    skills: [
      { name: 'Next.js / React', familiarity: 'daily' },
      { name: 'TypeScript', familiarity: 'daily' },
      { name: 'Tailwind CSS', familiarity: 'daily' },
      { name: 'Framer Motion', familiarity: 'regular' },
      { name: 'Three.js / WebGL', familiarity: 'occasional' },
      { name: 'HTML / CSS', familiarity: 'daily' },
    ],
  },
  {
    category: 'Backend',
    skills: [
      { name: 'Node.js', familiarity: 'daily' },
      { name: 'PostgreSQL', familiarity: 'regular' },
      { name: 'REST API', familiarity: 'daily' },
      { name: 'Prisma', familiarity: 'regular' },
      { name: 'Redis', familiarity: 'occasional' },
      { name: 'GraphQL', familiarity: 'occasional' },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'Vercel / CI/CD', familiarity: 'regular' },
      { name: 'Jest / Testing', familiarity: 'regular' },
      { name: 'Linux / Bash', familiarity: 'regular' },
      { name: 'AWS', familiarity: 'occasional' },
    ],
  },
]
